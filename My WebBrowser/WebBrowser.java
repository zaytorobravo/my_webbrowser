...
//HyperLink
	...
	if ( e.getSource() == search || e.getSource() == serch1 )
		...
		else{  try{ textField.setText("http://www.google.com");	
			editorPane.setPage(new URL( textField.getText() )); }catch(Exception fr){}  }
	...
	if ( e.getSource() == yahoo || e.getSource() == yahoo1 )
		...
		else{  try{ textField.setText("http://www.yahoo.com");	
			editorPane.setPage(new URL( textField.getText() )); }catch(Exception fr){}  }
